                    ...
                    >
                        <div className="content">
                            <div className="info">
                                ...
                                <div className="text">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</div>
                                <a href="/stores">See the store</a>
                            </div>
                        </div>
                    </div>
